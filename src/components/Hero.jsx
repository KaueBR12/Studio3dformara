    ...
    <section className="hero" id="hero">
      ...
      <div className="hero-content">
        ...
        <div className="hero-social">
          <a href="https://www.instagram.com/maker_formara?igsh=dnJlejQ3eXluMXdw" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-button instagram">
